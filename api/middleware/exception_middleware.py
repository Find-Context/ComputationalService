...
from core.exceptions import DatabaseConnectionError, DuplicatedPrimaryKeyError, NoContentError
...
class GlobalExceptionMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        try:
            ...
            print(f"No content error: {e}")

            return JSONResponse(
                status_code=status.HTTP_204_NO_CONTENT,
                content={"message": "No content error: " + str(e)},
            )
